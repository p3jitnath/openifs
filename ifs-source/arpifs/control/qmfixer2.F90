...
ASSOCIATE(LEXTRADF=>YGFL%LEXTRADF, LTRCMFIX_PS=>YGFL%LTRCMFIX_PS, &
 & NDIM=>YGFL%NDIM, NDIM1=>YGFL%NDIM1, NFLDSFIX=>YGFL%NFLDSFIX, &
 & NMFDIAGLEV=>YGFL%NMFDIAGLEV, NMFIXFLDS=>YGFL%NMFIXFLDS, &
 & NOPTMFPR=>YGFL%NOPTMFPR, NOPTVFE=>YGFL%NOPTVFE, YCOMP=>YGFL%YCOMP, &
 & ZMFIXEPS=>YGFL%ZMFIXEPS, &
