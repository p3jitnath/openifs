...
ASSOCIATE(NDIM=>YGFL%NDIM, NDIM1=>YGFL%NDIM1, NMFDIAGLEV=>YGFL%NMFDIAGLEV, &
 & NNEGAFIX=>YGFL%NNEGAFIX, NNEGFLDS=>YGFL%NNEGFLDS, &
 & NOPTNEGFIX=>YGFL%NOPTNEGFIX, NOPTVFE=>YGFL%NOPTVFE, YCOMP=>YGFL%YCOMP, &
