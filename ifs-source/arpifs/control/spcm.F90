    ...
    IF (LLONEM) THEN
      ...
      IF (YDDYNA%LNHEE.AND.(.NOT.YDDYNA%LSI_NHEE)) THEN
        ...
        DO JMLOC=NPTRMF(MYSETN),NPTRMF(MYSETN+1)-1
          ...
          ISTA=NSPSTAF(IM)
          IEND=ISTA+2*(NSMAX+1-IM)-1
          CALL SPNHSI(YDGEOMETRY,YDLDDH,YDMODEL%YRML_GCONF%YRRIP,YDDYN,IM,JMLOC,ISTA,IEND,LLONEM,&
    ...
    ELSE
      ...
      IF (NSPEC2V > 0) THEN
        ...
        IF (YDDYNA%LNHEE.AND.(.NOT.YDDYNA%LSI_NHEE)) THEN
          ...
          CALL SPNHSI(YDGEOMETRY,YDLDDH,YDMODEL%YRML_GCONF%YRRIP,YDDYN,IM,IMLOC,1,NSPEC2V,LLONEM,&
           & ZSPVORG,ZSPDIVG,ZSPTG,ZSPSPG,ZSPSPDG,ZSPSVDG,&
           & ZSPTNDSI_VORG,ZSPTNDSI_DIVG,ZSPTNDSI_TG,ZSPTNDSI_SPDG,ZSPTNDSI_SVDG)
