...
ASSOCIATE(YDDIM=>YDGEOMETRY%YRDIM,YDDIMV=>YDGEOMETRY%YRDIMV, &
 & YDGEM=>YDGEOMETRY%YRGEM, YDMP=>YDGEOMETRY%YRMP,  YDVAB=>YDGEOMETRY%YRVAB, YDVETA=>YDGEOMETRY%YRVETA, &
 ...
 & YDGSGEOM_NB=>YDGEOMETRY%YRGSGEOM_NB,  YDSPGEOM=>YDGEOMETRY%YSPGEOM, YDPTRSLB1=>YDML_DYN%YRPTRSLB1 ) 

ASSOCIATE(LEXTRADF=>YGFL%LEXTRADF, LTRCMFIX_PS=>YGFL%LTRCMFIX_PS, LTRCMFQM=>YGFL%LTRCMFQM, &
 & LTRCMFP=>YGFL%LTRCMFP, NDIM=>YGFL%NDIM, NDIM1=>YGFL%NDIM1, &
 & NFLDSFIX=>YGFL%NFLDSFIX, NMFDIAGLEV=>YGFL%NMFDIAGLEV, &
 & NMFIXFLDS=>YGFL%NMFIXFLDS, NOPTMFBC=>YGFL%NOPTMFBC, NOPTVFE=>YGFL%NOPTVFE, &
 & YCOMP=>YGFL%YCOMP, &
 ...
 & NDIMGMVS=>YDGMV%NDIMGMVS, YT0=>YDGMV%YT0, YT1=>YDGMV%YT1, &
 & MSLB1GFL9=>YDPTRSLB1%MSLB1GFL9, NFLDSLB1=>YDPTRSLB1%NFLDSLB1)
!------------------------------------------------------------------------------
...
!$OMP& PRIVATE(JKGLO,IEND,IBL,JROF)
  DO JKGLO=1,NGPTOT,NPROMA
    ...
    IBL=(JKGLO-1)/NPROMA+1
    DO JROF=IST,IEND
      ZPRES0(JROF,NFLEVG,IBL) = EXP(PGMVS(JROF,YT0%MSP,IBL))
