...
ASSOCIATE(YDDIM=>YDGEOMETRY%YRDIM, &
 & YDDIMV=>YDGEOMETRY%YRDIMV,YDGEM=>YDGEOMETRY%YRGEM, YDMP=>YDGEOMETRY%YRMP,  YDVAB=>YDGEOMETRY%YRVAB, &
...
ASSOCIATE(LEXTRADF=>YGFL%LEXTRADF, LTRCMFIX_PS=>YGFL%LTRCMFIX_PS, &
 ...
 & NOPTVFE=>YGFL%NOPTVFE, YCOMP=>YGFL%YCOMP, ZMFIXEPS=>YGFL%ZMFIXEPS, &
