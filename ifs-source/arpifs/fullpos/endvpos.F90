...
SUBROUTINE ENDVPOS(KLMOD,YDQTYPE,YDAUX,YDCLIMO,YDNAMFPSCI,YDAFN,YDFPGEO,YDFPVAB,YDGEOMETRY,YDML_GCONF,YDDYNA,YDML_PHY_MF,LDZ0H,CDCONF, &
...
!     GFPBUF(.,IATSI,.) is already a combination of interpolated Ts and SST
  ...
  ENDIF
  PGP(:,:,JBLOC) = 0.0_JPRB
  CALL ENDPOS(YDQTYPE,YDNAMFPSCI,YDAFN,KLMOD,YDFPVAB,YDGEOMETRY,YDML_GCONF,YDDYNA,YDML_PHY_MF,LDZ0H, &
