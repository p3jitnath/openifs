...
! Convection to cloud communication
  ...
  TYPE(FIELD_2D), POINTER :: F_PCAPE, F_PPDEPL, F_PCBASE, F_PCBASEA, F_PCTOPC, F_P0DEGL, F_PM10DEGL, F_PVISIH, F_PVDISCU, F_PVDIS, &
  ...
  TYPE(FIELD_INT2D), POINTER :: F_ITYPE, F_ICBOT, F_ICTOP, F_IPBLTYPE, F_ICBOT_LIG, F_ICTOP_LIG
