...
ALLOCATE (YDELBC_FIELDS%GMVCPL(YDGEOMETRY%YRELBC_GEO%NEDLST,YDGEOMETRY%YRDIMV%NFLEVG,YDML_LBC%YYTGMVCPL%NDIMT,IW))
...
ALLOCATE (YDELBC_FIELDS%GMVSCPL(YDGEOMETRY%YRELBC_GEO%NEDLST,YDML_LBC%YYTGMVSCPL%NDIMT,IW))
IF (LALLOPR) WRITE(NULOUT,"(1X,'ARRAY ',A10,' ALLOCATED ',8I8)")&
 & 'YDELBC_FIELDS%GMVSCPL  ',SIZE(YDELBC_FIELDS%GMVSCPL  ),SHAPE(YDELBC_FIELDS%GMVSCPL  )
ALLOCATE (YDELBC_FIELDS%GFLCPL(YDGEOMETRY%YRELBC_GEO%NEDLST,YDGEOMETRY%YRDIMV%NFLEVG,YDML_LBC%NDIMCPL,IW))
IF (LALLOPR) WRITE(NULOUT,"(1X,'ARRAY ',A10,' ALLOCATED ',8I8)")&
 & 'YDELBC_FIELDS%GFLCPL   ',SIZE(YDELBC_FIELDS%GFLCPL   ),SHAPE(YDELBC_FIELDS%GFLCPL   )
IF(LUNBC) THEN
  ALLOCATE (YDELBC_FIELDS%GMVUCPL(YDGEOMETRY%YRGEM%NGPTOT,YDGEOMETRY%YRDIMV%NFLEVG,YDML_LBC%YYTGMVCPL%NDIMT,IW))
  IF (LALLOPR) WRITE(NULOUT,"(1X,'ARRAY ',A10,' ALLOCATED ',8I8)")&
   & 'YDELBC_FIELDS%GMVUCPL   ',SIZE(YDELBC_FIELDS%GMVUCPL   ),SHAPE(YDELBC_FIELDS%GMVUCPL   )
  ALLOCATE (YDELBC_FIELDS%GMVSUCPL(YDGEOMETRY%YRGEM%NGPTOT,YDML_LBC%YYTGMVSCPL%NDIMT,IW))
  IF (LALLOPR) WRITE(NULOUT,"(1X,'ARRAY ',A10,' ALLOCATED ',8I8)")&
   & 'YDELBC_FIELDS%GMVSUCPL  ',SIZE(YDELBC_FIELDS%GMVSUCPL  ),SHAPE(YDELBC_FIELDS%GMVSUCPL  )
  ALLOCATE (YDELBC_FIELDS%GFLUCPL(YDGEOMETRY%YRGEM%NGPTOT,YDGEOMETRY%YRDIMV%NFLEVG,YDML_LBC%NDIMCPL,IW))
  IF (LALLOPR) WRITE(NULOUT,"(1X,'ARRAY ',A10,' ALLOCATED ',8I8)")&
   & 'YDELBC_FIELDS%GFULCPL   ',SIZE(YDELBC_FIELDS%GFLUCPL   ),SHAPE(YDELBC_FIELDS%GFLUCPL   )
ENDIF

ALLOCATE (YDELBC_FIELDS%GMVSTENC(YDGEOMETRY%YRELBC_GEO%NEDLST,YDML_LBC%YYTGMVSTENC%NDIMT,IW_TENC))
IF (LALLOPR) WRITE(NULOUT,"(1X,'ARRAY ',A10,' ALLOCATED ',8I8)")&
