...
ASSOCIATE(NDGENG=>YDDIM%NDGENG, NDGLG=>YDDIM%NDGLG, NDGSAG=>YDDIM%NDGSAG, &
 ...
 & NSMAX=>YDDIM%NSMAX, NSPEC2=>YDDIM%NSPEC2, NSPEC2G=>YDDIM%NSPEC2G, &
 ...
 & NBSETLEV=>YDMP%NBSETLEV, NBSETSP=>YDMP%NBSETSP, NDIM0G=>YDMP%NDIM0G, &
 & NPOSSP=>YDMP%NPOSSP, NPTRLL=>YDMP%NPTRLL, &
 & NSTADD=>YDRIP%NSTADD, NSTASS=>YDRIP%NSTASS, TSTEP=>YDRIP%TSTEP)
! ----------------------------------------------------------------------------
