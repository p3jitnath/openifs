...
ASSOCIATE(YDDIM=>YDGEOMETRY%YRDIM,YDDIMV=>YDGEOMETRY%YRDIMV,YDGEM=>YDGEOMETRY%YRGEM, YDMP=>YDGEOMETRY%YRMP, &
 ...
 & YDSPGEOM=>YDGEOMETRY%YSPGEOM, YDPHY=>YDMODEL%YRML_PHY_MF%YRPHY,YDMCC=>YDMODEL%YRML_AOC%YRMCC, &
  & YDRIP=>YDMODEL%YRML_GCONF%YRRIP,YDDPHY=>YDMODEL%YRML_PHY_G%YRDPHY,YDERAD=>YDMODEL%YRML_PHY_RAD%YRERAD,  &
  & YDPHY1=>YDMODEL%YRML_PHY_MF%YRPHY1, YDOZO=>YDMODEL%YRML_CHEM%YROZO)

ASSOCIATE(NTVGLA=>YDPHY1%NTVGLA, ALCRIN=>YDPHY1%ALCRIN, NTVMER=>YDPHY1%NTVMER, &
 & ALBMER=>YDPHY1%ALBMER, RD2GLA=>YDPHY1%RD2GLA, RD1=>YDPHY1%RD1, &
 & ALRCN1=>YDPHY1%ALRCN1, WSMX=>YDPHY1%WSMX, RZ0MER=>YDPHY1%RZ0MER, &
 & WPMX=>YDPHY1%WPMX, EA=>YDPHY1%EA, RZ0GLA=>YDPHY1%RZ0GLA, &
 & EMCRIN=>YDPHY1%EMCRIN, RZHZ0M=>YDPHY1%RZHZ0M, EMMMER=>YDPHY1%EMMMER, &
 & RZHZ0G=>YDPHY1%RZHZ0G, RD2MER=>YDPHY1%RD2MER, TMERGL=>YDPHY1%TMERGL, &
 & ALBGLA=>YDPHY1%ALBGLA, EMMGLA=>YDPHY1%EMMGLA, &
 & NDGENG=>YDDIM%NDGENG, NDGENL=>YDDIM%NDGENL, NDGLG=>YDDIM%NDGLG, &
 & NDGSAG=>YDDIM%NDGSAG, NDGSAL=>YDDIM%NDGSAL, NDLON=>YDDIM%NDLON, &
 ...
 & NSTADD=>YDRIP%NSTADD, &
 & SD_VA=>YDSURF%SD_VA, SD_VF=>YDSURF%SD_VF, SD_VP=>YDSURF%SD_VP, &
 & SD_VV=>YDSURF%SD_VV, SP_RR=>YDSURF%SP_RR, SP_SB=>YDSURF%SP_SB, &
 & SP_SG=>YDSURF%SP_SG, YSD_VA=>YDSURF%YSD_VA, YSD_VAD=>YDSURF%YSD_VAD, &
 & YSD_VF=>YDSURF%YSD_VF, YSD_VFD=>YDSURF%YSD_VFD, YSD_VP=>YDSURF%YSD_VP, &
 & YSD_VPD=>YDSURF%YSD_VPD, YSD_VV=>YDSURF%YSD_VV, YSD_VVD=>YDSURF%YSD_VVD, &
 & YSP_RR=>YDSURF%YSP_RR, YSP_SB=>YDSURF%YSP_SB, YSP_SBD=>YDSURF%YSP_SBD, &
 & YSP_SG=>YDSURF%YSP_SG, YSP_SGD=>YDSURF%YSP_SGD,&
 & LSOLV=>YDPHY%LSOLV, LRAYFM=>YDPHY%LRAYFM, LSNV=>YDPHY%LSNV, &
 & LRAYFM15=>YDPHY%LRAYFM15, LOZONE=>YDPHY%LOZONE)
!     ------------------------------------------------------------------
