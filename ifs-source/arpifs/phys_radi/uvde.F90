...
!**** *UVDE* - DELTA-EDDINGTON IN A CLOUDY LAYER
...
IF (LHOOK) CALL DR_HOOK('UVDE',0,ZHOOK_HANDLE)
...
IF (LHOOK) CALL DR_HOOK('UVDE',1,ZHOOK_HANDLE)
END SUBROUTINE UVDE
