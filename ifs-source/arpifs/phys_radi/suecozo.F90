...
SUBROUTINE SUECOZO (PYTIME,YDEOZOC)
...
IF (LHOOK) CALL DR_HOOK('SUECOZO',0,ZHOOK_HANDLE)
ZYTIME=PYTIME
...
DO JMN=1,21
  YDEOZOC%COZQC(JMN)=ZOZQC0(JMN)+2.0_JPRB*(ZOZQC1(JMN)*ZC1YT+ZOZQC2(JMN)*ZS1YT &
   & +ZOZQC3(JMN)*ZC2YT+ZOZQC4(JMN)*ZS2YT)  
  YDEOZOC%COZHC(JMN)=ZOZHC0(JMN)+2.0_JPRB*(ZOZHC1(JMN)*ZC1YT+ZOZHC2(JMN)*ZS1YT &
   & +ZOZHC3(JMN)*ZC2YT+ZOZHC4(JMN)*ZS2YT)  
ENDDO
DO JMN=1,15
  YDEOZOC%COZQS(JMN)=ZOZQS0(JMN)+2.0_JPRB*(ZOZQS1(JMN)*ZC1YT+ZOZQS2(JMN)*ZS1YT &
   & +ZOZQS3(JMN)*ZC2YT+ZOZQS4(JMN)*ZS2YT)  
  YDEOZOC%COZHS(JMN)=ZOZHS0(JMN)+2.0_JPRB*(ZOZHS1(JMN)*ZC1YT+ZOZHS2(JMN)*ZS1YT &
   & +ZOZHS3(JMN)*ZC2YT+ZOZHS4(JMN)*ZS2YT)  
ENDDO
!     ------------------------------------------------------------------

IF (LHOOK) CALL DR_HOOK('SUECOZO',1,ZHOOK_HANDLE)
