...
!**   *VDFDIFCS* - Does the implicit computation for diffusion of tracers

!     A. Beljaars       ECMWF    18-03-2004

!     Modifications
!     -------------
!     P. Lopez          ECMWF    13-02-2006 : Nonlinear version 
!                                             to be used in adjoint.         
...
!     *VDFDIFCS* is called by *VDFMAINS*
...
IF (LHOOK) CALL DR_HOOK('VDFDIFCS',0,ZHOOK_HANDLE)
!ZALF=RVDIFTS
ZALF=1.0_JPRB
...
IF (LHOOK) CALL DR_HOOK('VDFDIFCS',1,ZHOOK_HANDLE)
