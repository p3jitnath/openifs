...
ASSOCIATE(RAEDC=>YDEAERD%RAEDC, RAEDS=>YDEAERD%RAEDS, RAELC=>YDEAERD%RAELC, &
 & RAELS=>YDEAERD%RAELS, RAESC=>YDEAERD%RAESC, RAESS=>YDEAERD%RAESS, &
 & RAEUC=>YDEAERD%RAEUC, RAEUS=>YDEAERD%RAEUS, RCAEROS=>YDEAERD%RCAEROS)
RAESC = (/&
