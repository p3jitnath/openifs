...
REAL(KIND=JPRB) :: GP1(JPGPP)
REAL(KIND=JPRB) :: SNS1(KLON)
REAL(KIND=JPRB) :: ASN1(KLON)
REAL(KIND=JPRB) :: RSN1(KLON)
REAL(KIND=JPRB) :: TSN1(KLON)
REAL(KIND=JPRB) :: TSA1(ICSS)
REAL(KIND=JPRB) :: WSA1(ICSS)
REAL(KIND=JPRB) :: TIA1(ICSS)
REAL(KIND=JPRB) :: WL1(KLON)
REAL(KIND=JPRB) :: TL1(KLON)
REAL(KIND=JPRB) :: EXTRP1(50,20)
REAL(KIND=JPRB) :: XTRP21(50)
!REAL(KIND=JPRB) :: EXTRP1(YRPHYDS%JPCXP,YRPHYDS%JPVXP)
!REAL(KIND=JPRB) :: XTRP21(YRPHYDS%JPVXP2)
