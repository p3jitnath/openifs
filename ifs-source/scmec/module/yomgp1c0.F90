...
REAL(KIND=JPRB) :: GP0(JPGPP)
REAL(KIND=JPRB) :: SNS0(KLON)
REAL(KIND=JPRB) :: ASN0(KLON)
REAL(KIND=JPRB) :: RSN0(KLON)
REAL(KIND=JPRB) :: TSN0(KLON)
REAL(KIND=JPRB) :: TSA0(ICSS)
REAL(KIND=JPRB) :: WSA0(ICSS)
REAL(KIND=JPRB) :: TIA0(ICSS)
REAL(KIND=JPRB) :: WL0(KLON)
REAL(KIND=JPRB) :: TL0(KLON)
REAL(KIND=JPRB) :: EXTRP0(50,20)
REAL(KIND=JPRB) :: XTRP20(50)
!REAL(KIND=JPRB) :: EXTRP0(YRPHYDS%JPCXP,YRPHYDS%JPVXP)
!REAL(KIND=JPRB) :: XTRP20(YRPHYDS%JPVXP2)
